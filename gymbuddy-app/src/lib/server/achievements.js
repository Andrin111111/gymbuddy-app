...
export const ACHIEVEMENTS_CATALOG = [
  // Streak
  { key: "streak_3", name: "Streak 3", category: "streak" },
  { key: "streak_7", name: "Streak 7", category: "streak" },
  { key: "streak_14", name: "Streak 14", category: "streak" },
  { key: "streak_30", name: "Streak 30", category: "streak" },
  { key: "streak_100", name: "Streak 100", category: "streak" },
  // Total workouts
  { key: "workouts_10", name: "Workouts 10", category: "workouts" },
  { key: "workouts_25", name: "Workouts 25", category: "workouts" },
  { key: "workouts_50", name: "Workouts 50", category: "workouts" },
  { key: "workouts_100", name: "Workouts 100", category: "workouts" },
  { key: "workouts_250", name: "Workouts 250", category: "workouts" },
  { key: "workouts_500", name: "Workouts 500", category: "workouts" },
  // PR count
  { key: "prs_10", name: "PRs 10", category: "prs" },
  { key: "prs_25", name: "PRs 25", category: "prs" },
  { key: "prs_50", name: "PRs 50", category: "prs" },
  { key: "prs_100", name: "PRs 100", category: "prs" },
  { key: "prs_250", name: "PRs 250", category: "prs" },
  // Social
  { key: "friends_1", name: "Friends 1", category: "social" },
  { key: "friends_5", name: "Friends 5", category: "social" },
  { key: "friends_10", name: "Friends 10", category: "social" },
  { key: "friends_25", name: "Friends 25", category: "social" },
  { key: "train_with_buddy_5", name: "Buddy Sessions 5", category: "social" },
  { key: "train_with_buddy_25", name: "Buddy Sessions 25", category: "social" },
  { key: "train_with_buddy_100", name: "Buddy Sessions 100", category: "social" },
  // Consistency
  { key: "weeks_active_4", name: "Weeks Active 4", category: "consistency" },
  { key: "weeks_active_12", name: "Weeks Active 12", category: "consistency" },
  { key: "weeks_active_24", name: "Weeks Active 24", category: "consistency" },
  // Season
  { key: "season_top_10_friends", name: "Season Top 10", category: "season" },
  { key: "season_top_3_friends", name: "Season Top 3", category: "season" },
  { key: "season_top_1_friends", name: "Season Winner", category: "season" }
];
